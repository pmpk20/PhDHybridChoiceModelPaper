...
apollo_control = list(
  modelName  = "Q1ICLV_2022_03_21",
  modelDescr = "Q1ICLV_2022_03_21",
  indivID    = "ID",
  mixing     = TRUE,
  nCores     = 1,
  noValidation=TRUE)
...
## What to keep fixed in estimation:
apollo_fixed = c()
...
Q1ICLV_2022_03_21 = apollo_estimate(apollo_beta, apollo_fixed, apollo_probabilities, apollo_inputs)

apollo_modelOutput(Q1ICLV_2022_03_21,modelOutput_settings = list(printPVal=TRUE))
xtable::xtable(round(data.frame(apollo_modelOutput(Q1ICLV_2022_03_21,modelOutput_settings = list(printPVal=TRUE))),3),digits=3)


## Elicit conditionals and unconditionals:
Q1ICLV_2022_03_21_UCWTP <- apollo_unconditionals(Q1ICLV_2022_03_21,apollo_probabilities,apollo_inputs)
Q1ICLV_2022_03_21_ConWTP <- apollo_conditionals(Q1ICLV_2022_03_21,apollo_probabilities,apollo_inputs)


## Save outputs
saveRDS(Q1ICLV_2022_03_21,"Q1ICLV_2022_03_21.rds")
saveRDS(Q1ICLV_2022_03_21_UCWTP,"Q1ICLV_2022_03_21_UCWTP.rds")
saveRDS(Q1ICLV_2022_03_21_ConWTP,"Q1ICLV_2022_03_21_ConWTP.rds")
# Q1ICLV_2022_03_21 <- readRDS("Q1ICLV_2022_03_21.rds")

# WTP:
# Model <- Q1ICLV_2022_03_21
...
# Q1ICLV_2022_03_21WTP <- median(-Model$estimate["intercept"]+CVunconditionals7F$LV/Model$estimate["b_bid"])
