...
## Function: Estimates ICLV for Q2 ("Question Two")
...
database$Q2Bid <- database$Q2Bid/100
database$Q6ResearchResponse <-database$Q6ResearchResponse-1
database$Q2TreatmentResponse <-database$Q2TreatmentResponse-1



# ------------------------------------------------------------------------------
#### Section 2: Apollo setup ####
# ----------------------------------------------------------------------------


## Watch out for NCores if not on high performance computing
apollo_control = list(
  modelName  = "Q2ICLV_2022_03_21",
  modelDescr = "Q2ICLV_2022_03_21",
  indivID    = "ID",
  mixing     = TRUE,
  nCores     = 1,
  noValidation=TRUE)
...
apollo_randCoeff=function(apollo_beta, apollo_inputs){
  ...
  randcoeff[["LV"]] = gamma_Age*Age +
    gamma_Gender*Q1Gender + gamma_Distance*Distance + 
    gamma_Income*IncomeDummy + gamma_Experts*Experts + 
    gamma_BP*BP + gamma_Charity*Charity + 
...
Q2ICLV_2022_03_21 = apollo_estimate(apollo_beta, apollo_fixed, apollo_probabilities, apollo_inputs)

apollo_modelOutput(Q2ICLV_2022_03_21,modelOutput_settings = list(printPVal=TRUE))
xtable::xtable(round(data.frame(apollo_modelOutput(Q2ICLV_2022_03_21,modelOutput_settings = list(printPVal=TRUE))),3),digits=3)


## Elicit conditionals and unconditionals:
Q2ICLV_2022_03_21_UCWTP <- apollo_unconditionals(Q2ICLV_2022_03_21,apollo_probabilities,apollo_inputs)
Q2ICLV_2022_03_21_ConWTP <- apollo_conditionals(Q2ICLV_2022_03_21,apollo_probabilities,apollo_inputs)


## Save outputs
saveRDS(Q2ICLV_2022_03_21,"Q2ICLV_2022_03_21.rds")
saveRDS(Q2ICLV_2022_03_21_UCWTP,"Q2ICLV_2022_03_21_UCWTP.rds")
saveRDS(Q2ICLV_2022_03_21_ConWTP,"Q2ICLV_2022_03_21_ConWTP.rds")
