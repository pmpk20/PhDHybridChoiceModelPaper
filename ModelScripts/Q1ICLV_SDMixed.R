...
database$Q6ResearchCertainty <- ifelse(database$Q6ResearchCertainty<=1,0,1)



# Model parameters
apollo_control = list(
  modelName  = "Q1ICLV_SDMixed_2022_06_01",
  modelDescr = "Q1ICLV_SDMixed_2022_06_01",
  indivID    = "ID",
  mixing     = TRUE,
  nCores     = 1,
  noValidation=TRUE) ## rigging the estimation to work somehow
...
apollo_randCoeff=function(apollo_beta, apollo_inputs){
  randcoeff = list()
  randcoeff[["LV"]] =   gamma_Experts*Experts + 
    gamma_BP*BP + 
    gamma_Charity*Charity + eta
  return(randcoeff)}
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  op_settings = list(outcomeOrdered= Q6ResearchResponse,
                     V      = intercept + 
                       ...
                       beta_Certainty*Q6ResearchCertainty +
...
Q1ICLV_SDMixed_2022_06_01 = apollo_estimate(apollo_beta, apollo_fixed, apollo_probabilities, apollo_inputs)

apollo_modelOutput(Q1ICLV_SDMixed_2022_06_01,modelOutput_settings = list(printPVal=TRUE))
xtable::xtable(round(data.frame(apollo_modelOutput(Q1ICLV_SDMixed_2022_06_01,modelOutput_settings = list(printPVal=TRUE))),3),digits=3)
apollo_saveOutput(Q1ICLV_SDMixed_2022_06_01,saveOutput_settings = list(printPVal=TRUE))


## Elicit conditionals and unconditionals:
Q1ICLV_SDMixed_2022_06_01_UCWTP <- apollo_unconditionals(Q1ICLV_SDMixed_2022_06_01,apollo_probabilities,apollo_inputs)
Q1ICLV_SDMixed_2022_06_01_ConWTP <- apollo_conditionals(Q1ICLV_SDMixed_2022_06_01,apollo_probabilities,apollo_inputs)


## Save outputs
saveRDS(Q1ICLV_SDMixed_2022_06_01,"Q1ICLV_SDMixed_2022_06_01.rds")
saveRDS(Q1ICLV_SDMixed_2022_06_01_UCWTP,"Q1ICLV_SDMixed_2022_06_01_UCWTP.rds")
saveRDS(Q1ICLV_SDMixed_2022_06_01_ConWTP,"Q1ICLV_SDMixed_2022_06_01_ConWTP.rds")
# Q1ICLV_SDMixed_2022_06_01 <- readRDS("Q1ICLV_SDMixed_2022_06_01.rds")

# WTP:
# Model <- Q1ICLV_SDMixed_2022_06_01
...
# Q1ICLV_SDMixed_2022_06_01WTP <- median(-Model$estimate["intercept"]+CVunconditionals7F$LV/Model$estimate["b_bid"])
