...
# database$Q7TreatmentCertainty <- ifelse(database$Q7TreatmentCertainty<=1,0,1)


## Model parameters here
apollo_control = list(
  modelName  = "Q2ICLV_SDMixed_2022_06_01",
  modelDescr = "Q2ICLV_SDMixed_2022_06_01",
  indivID    = "ID",
  mixing     = TRUE,
  nCores     = 1,
  noValidation=TRUE)
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  op_settings = list(outcomeOrdered= Q7TreatmentResponse,
                     V      = intercept + b_bid*Q7Bid+lambda*LV+
                       ...
                       beta_Certainty*Q7TreatmentCertainty +
...
Q2ICLV_SDMixed_2022_06_01 = apollo_estimate(apollo_beta, apollo_fixed, apollo_probabilities, apollo_inputs)

apollo_modelOutput(Q2ICLV_SDMixed_2022_06_01,modelOutput_settings = list(printPVal=TRUE))
xtable::xtable(round(data.frame(apollo_modelOutput(Q2ICLV_SDMixed_2022_06_01,modelOutput_settings = list(printPVal=TRUE))),3),digits=3)
apollo_saveOutput(Q2ICLV_SDMixed_2022_06_01,saveOutput_settings = list(printPVal=TRUE))


## Elicit WTP:
Q2ICLV_SDMixed_2022_06_01_UCWTP <- apollo_unconditionals(Q2ICLV_SDMixed_2022_06_01,apollo_probabilities,apollo_inputs)
Q2ICLV_SDMixed_2022_06_01_ConWTP <- apollo_conditionals(Q2ICLV_SDMixed_2022_06_01,apollo_probabilities,apollo_inputs)


## Save outputs:
saveRDS(Q2ICLV_SDMixed_2022_06_01,"Q2ICLV_SDMixed_2022_06_01.rds")
saveRDS(Q2ICLV_SDMixed_2022_06_01_UCWTP,"Q2ICLV_SDMixed_2022_06_01_UCWTP.rds")
saveRDS(Q2ICLV_SDMixed_2022_06_01_ConWTP,"Q2ICLV_SDMixed_2022_06_01_ConWTP.rds")
