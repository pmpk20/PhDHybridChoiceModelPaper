...
## Model parameters
apollo_control = list(
  modelName  = "Q2ICLV_NoME_2022_05_31",
  modelDescr = "Q2ICLV_NoME_2022_05_31",
  indivID    = "ID",
  mixing     = TRUE,
  nCores     = 1,
  noValidation=TRUE)
...
Q2ICLV_NoME_2022_05_31 = apollo_estimate(apollo_beta, apollo_fixed, apollo_probabilities, apollo_inputs)

apollo_modelOutput(Q2ICLV_NoME_2022_05_31,modelOutput_settings = list(printPVal=TRUE))
xtable::xtable(round(data.frame(apollo_modelOutput(Q2ICLV_NoME_2022_05_31,modelOutput_settings = list(printPVal=TRUE))),3),digits=3)
apollo_saveOutput(Q2ICLV_NoME_2022_05_31,saveOutput_settings = list(printPVal=TRUE))


## Elicit WTP:
Q2ICLV_NoME_2022_05_31_UCWTP <- apollo_unconditionals(Q2ICLV_NoME_2022_05_31,apollo_probabilities,apollo_inputs)
Q2ICLV_NoME_2022_05_31_ConWTP <- apollo_conditionals(Q2ICLV_NoME_2022_05_31,apollo_probabilities,apollo_inputs)


## Save outputs:
saveRDS(Q2ICLV_NoME_2022_05_31,"Q2ICLV_NoME_2022_05_31.rds")
saveRDS(Q2ICLV_NoME_2022_05_31_UCWTP,"Q2ICLV_NoME_2022_05_31_UCWTP.rds")
saveRDS(Q2ICLV_NoME_2022_05_31_ConWTP,"Q2ICLV_NoME_2022_05_31_ConWTP.rds")
